...
```
3. Marque o repositório com uma estrela ⭐

# 🎡 Site de demostração

Aqui você pode personalizar seu cartão Streak Stats com uma visualização ao vivo

https://streak-stats.demolab.com

[![Demo Site](https://github.com/rxaviersantos/readme.md/assets/85380530/d5e3dcb0-82e1-4524-b352-c99c5fb29fb6 "Demo Site")](http://streak-stats.demolab.com/demo/)

# 🖌️ Temas 

Para habilitar um tema, anexe ```&theme=``` seguido pelo nome do tema ao final da URL de origem:

```md
[![GitHub Streak](https://streak-stats.demolab.com/?user=rxaviersantos&theme=dark)](https://git.io/streak-stats)
````
